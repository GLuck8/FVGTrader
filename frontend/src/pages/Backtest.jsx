          ...
          {result && (
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <StatCard label="Max Drawdown" value={`$${result.stats.max_drawdown}`} color="bear" />
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {Object.entries(result.by_instrument).map(([sym, s]) => (
                          <tr key={sym} className="border-b border-surface-border/50">
                            ...
                            <td className={clsx('py-2', s.profit_factor >= 1 ? 'text-bull' : 'text-bear')}>
                  ...
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="text-left text-gray-500 border-b border-surface-border">
                        {['Symbol', 'Dir', 'Entry', 'Exit', 'P&L', 'Result', 'OB'].map(h => (
                    ...
                    <tbody>
                      {result.trades.map((t, i) => (
                        <tr key={i} className="border-b border-surface-border/40">
                          ...
                          <td className="py-1.5 pr-3 text-gray-400 capitalize">{t.exit_reason ?? '—'}</td>
                          <td className="py-1.5">{t.ob_protected ? '✓' : ''}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
